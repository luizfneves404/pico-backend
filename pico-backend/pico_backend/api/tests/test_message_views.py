...
class MessageForMemberTestCase(PatchingAndRedisTestCase):
    ...
    def test_create_no_text_attachment_message_as_member(self):
        # Create dummy files
        with open("api/tests/test_files/test_photo.png", "rb") as file:
    ...
    def test_create_pdf_file_attachment_message_as_member(self):
        # Create dummy files
        with open("api/tests/test_files/test_pdf.pdf", "rb") as file:
            file = SimpleUploadedFile(
    ...
    def test_create_txt_file_attachment_message_as_member(self):
        # Create dummy files
        with open("api/tests/test_files/test_txt.txt", "rb") as file:
            file = SimpleUploadedFile(
    ...
    def test_create_docx_file_attachment_message_as_member(self):
        # Create dummy files
        with open("api/tests/test_files/test_docx.docx", "rb") as file:
            file = SimpleUploadedFile(
                "test_docx.docx",
                file.read(),
    ...
    def test_create_bad_file_type_attachment_message_as_member(self):
        # Create dummy files
        with open(
            "api/tests/test_files/sh_exec_with_photo_extension.png", "rb"
        ) as file:
            file = SimpleUploadedFile(
