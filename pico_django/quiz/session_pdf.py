...
registerFont(TTFont("SourceSans3", "pico_django/SourceSans3-Regular.ttf"))
registerFont(TTFont("SourceSans3-Bold", "pico_django/SourceSans3-Bold.ttf"))
registerFont(TTFont("SourceSans3-Italic", "pico_django/SourceSans3-Italic.ttf"))
